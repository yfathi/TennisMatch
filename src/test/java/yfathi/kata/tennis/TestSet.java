...
public class TestSet {
    ...
    @Test
    void testGoBacktoDeuceSimpleRule() throws RuleException {
        Set set = setService.init();
        // Rafal get to 5
        for (int i = 0; i < 20; i++) {
            setService.winPoint(set, 0);
    ...
    @Test
    void testNotWinBy6IfOpponenthasOver4Rule() throws RuleException {
        Set set = setService.init();
        // Rafal get to 5
        for (int i = 0; i < 20; i++) {
            setService.winPoint(set, 0);
    ...
    @Test
    void testActivateTieBreakRule() throws RuleException {
        Set set = setService.init();
        // Rafal get to 5
        for (int i = 0; i < 20; i++) {
            setService.winPoint(set, 0);
    ...
    @Test
    void testCantWinWith1DiffInTieBreakRule() throws RuleException {
        Set set = setService.init();
        // Rafal get to 5
        for (int i = 0; i < 20; i++) {
            setService.winPoint(set, 0);
    ...
    @Test
    void testTieBreakWinRule() throws RuleException {
        Set set = setService.init();
        // Rafal get to 5
        for (int i = 0; i < 20; i++) {
            setService.winPoint(set, 0);
